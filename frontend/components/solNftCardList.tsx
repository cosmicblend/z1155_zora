...
import ShNftCard from './solNftCard';
import useSWR from 'swr';
import { fetcher, baseUrl } from '../../services/solSimpleHash';
...
const SolNftCardList = ({ startIndex = 0, columnCount = 3 }) => {
