...
import ShNftCard from './opNftCard';
import useSWR from 'swr';
import { fetcher, baseUrl } from '../../services/opSimpleHash';
...
const OpNftCardList = ({ startIndex = 0, columnCount = 3 }) => {
